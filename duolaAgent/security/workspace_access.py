...
def _env_system_provider(environ: dict[str, str] | None = None) -> str | None:
    ...
    explicit_provider = env.get("DUOLA_WORKSPACE_SANDBOX_PROVIDER")
    enforced = env.get("DUOLA_WORKSPACE_SANDBOX_ENFORCED")
    compatibility = env.get("DUOLA_SANDBOX_ENFORCED")
