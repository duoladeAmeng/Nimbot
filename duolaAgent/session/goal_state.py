...
def runner_wall_llm_timeout_s(
    ...
    *,
    ...
    """Wall-clock cap for :class:`~duolaAgent.agent.runner.AgentRunner` when streaming an LLM.
    ...
    ``metadata`` when the caller already holds :attr:`~duolaAgent.session.manager.Session.metadata`
    for this turn.
    """
