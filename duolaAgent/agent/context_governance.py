...
from duolaAgent.utils.helpers import (
...
from duolaAgent.utils.runtime import ensure_nonempty_tool_result
...
class ContextGovernor:
    ...
    def input_budget(config: ContextGovernanceConfig) -> int:
        ...
        max_output = max(max_output, getattr(config.provider, "context_output_reservation", 0))
