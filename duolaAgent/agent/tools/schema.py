"""JSON Schema fragment types: all subclass :class:`~duolaAgent.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~duolaAgent.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~duolaAgent.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~duolaAgent.agent.tools.base.Schema`.
...
from duolaAgent.agent.tools.base import Schema
...
def tool_parameters_schema(
    ...
    **fields: Any,
    ...
    return ObjectSchema(
        ...
        properties={**(properties or {}), **fields},
    ).to_json_schema()


def string_schema(description: str, *, nullable: bool = False) -> dict[str, Any]:
    schema_type: str | list[str] = "string"
    if nullable:
...
def integer_schema(
    ...
    *,
    ...
    schema_type: str | list[str] = "integer"
    if nullable:
...
def boolean_schema(
    ...
    *,
    ...
    schema_type: str | list[str] = "boolean"
    if nullable:
